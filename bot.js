...
bot.on("message", message => {
    if (message.content === "blabla mister freeman") {
    	message.reply("Socks breaking news interrompt votre émission @everyone pour vous rappeler que notre grand gourou est parti dans des contrés encore inexploré pour répandre la bonne parole une fois de plus !
