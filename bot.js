...
bot.on("message", message => {
    if (message.content === "blabla mister freeman") {
    	message.reply("@everyone Socks breaking news interrompt votre émission pour vous rappeler que notre grand gourou est parti dans des contrés encore inexploré pour répandre la bonne parole une fois de plus !
